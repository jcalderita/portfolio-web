...
slug: swift-pills
date: 2026-05-27
description: Píldoras de cinco minutos sobre Swift que te enseñan cosas que ni siquiera habías considerado. Conocimiento que entra sin pedir hueco en la agenda.
...
Estar al día con <span class="high">Swift</span> es una de esas cosas que siempre tengo en la lista y que casi nunca consigo tachar. Cada WWDC trae cosas nuevas, el lenguaje evoluciona, la comunidad publica sin parar, y yo mientras tanto estoy con el proyecto, con las reuniones, con la vida. La información existe — el problema es encontrar el hueco para entrarle.
...
El blog de [Arturo Rivas](https://blog.arturorivas.com/) cambia la forma de consumir contenido sobre <span class="high">Swift</span>. Lo que él publica son píldoras de conocimiento: artículos cortos, de unos cinco minutos de lectura, donde te cuenta una cosa concreta y se va. Sin rodeos, sin relleno, sin "antes de empezar permítanme contextualizar".
...
Y como cada píldora va a una sola cosa, la retención es brutal. Cuando un artículo es largo necesito procesarlo a fondo, sentarme a estudiarlo y darle varias vueltas para que se quede. Cuando leo una píldora sobre, por ejemplo, cómo funciona <span class="high">@discardableResult</span> o un detalle de <span class="high">Sendable</span> que no había visto, ese concepto entra directamente. Era el único foco durante esos cinco minutos, y mi cabeza lo trata como tal.
...
Esto conecta con algo que ya conté en [Apple Coding Speed](/es/blog/apple-coding-speed/): la velocidad de comprensión no se entrena solo en formaciones largas. También se entrena en la exposición constante a conceptos bien explicados — y las píldoras son justo eso, entrenamiento continuo que sucede entre sesiones más estructuradas.

---
## Mi Resultado 🎯

Si trabajas con <span class="high">Swift</span> y se te están acumulando los enlaces "para cuando tenga un rato", el problema probablemente no es la cantidad de contenido — es el formato. Pásate por [blog.arturorivas.com](https://blog.arturorivas.com/) y prueba el modelo de las píldoras durante una semana.
