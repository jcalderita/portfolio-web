...
The site you're reading right now is generated with <span class="high">Saga</span>, compiled with Swift, and deployed on <span class="high">Cloudflare Pages</span> without Node ever touching my machine.
